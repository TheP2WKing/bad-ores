...
public class ModOreDict {
	public static void registerOreDict() {
		...
		ModRecipeHelper.addOreDict("blockCrappium", ModBlocks.CRAPPIUM_BLOCK, 0);
		ModRecipeHelper.addOreDict("blockEnderite", ModBlocks.ENDERITE_BLOCK, 0);
		ModRecipeHelper.addOreDict("blockAmadeum", ModBlocks.AMADEUM_BLOCK, 0);
		ModRecipeHelper.addOreDict("blockBarelygenerite", ModBlocks.BARELYGENERITE_BLOCK, 0);
		ModRecipeHelper.addOreDict("blockCopper", ModBlocks.COPPER_BLOCK, 0);
		ModRecipeHelper.addOreDict("blockMarmite", ModBlocks.MARMITE_BLOCK, 0);
		ModRecipeHelper.addOreDict("blockSmite", ModBlocks.SMITE_BLOCK, 0);
		ModRecipeHelper.addOreDict("blockFleesonsite", ModBlocks.FLEESONSITE_BLOCK, 0);
		ModRecipeHelper.addOreDict("blockNopium", ModBlocks.NOPIUM_BLOCK, 0);
		ModRecipeHelper.addOreDict("blockDiamondFake", ModBlocks.DIAMOND_BLOCK, 0);
		ModRecipeHelper.addOreDict("blockKakkarite", ModBlocks.KAKKARITE_BLOCK, 0);
		ModRecipeHelper.addOreDict("blockNosleeptonite", ModBlocks.NOSLEEPTONITE_BLOCK, 0);

		ModRecipeHelper.addOreDict("ingotPolite", ModItems.POLITE_INGOT, 0);
		ModRecipeHelper.addOreDict("gemCrashium", ModItems.CRASHIUM_GEMSTONE, 0);
		ModRecipeHelper.addOreDict("ingotCrappium", ModItems.CRAPPIUM_INGOT, 0);
		ModRecipeHelper.addOreDict("ingotEnderite", ModItems.ENDERITE_INGOT, 0);
		ModRecipeHelper.addOreDict("ingotAmadeum", ModItems.AMADEUM_INGOT, 0);
		ModRecipeHelper.addOreDict("ingotBarelygenerite", ModItems.BARELYGENERITE_INGOT, 0);
		ModRecipeHelper.addOreDict("ingotCopper", ModItems.COPPER_INGOT, 0);
		ModRecipeHelper.addOreDict("ingotUselessium", ModItems.USELESSIUM_INGOT, 0);
		ModRecipeHelper.addOreDict("ingotMarmite", ModItems.MARMITE_INGOT, 0);
		ModRecipeHelper.addOreDict("gemSmite", ModItems.SMITE_GEMSTONE, 0);
		ModRecipeHelper.addOreDict("ingotFleesonsite", ModItems.FLEESONSITE_INGOT, 0);
		ModRecipeHelper.addOreDict("ingotNopium", ModItems.NOPIUM_INGOT, 0);
