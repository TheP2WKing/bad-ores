...
public class BlockDiamondOre extends ModBlockOreBase {
	public BlockDiamondOre(String modid, String name, CreativeTabs tab, int minXp, int maxXp, Material material,
