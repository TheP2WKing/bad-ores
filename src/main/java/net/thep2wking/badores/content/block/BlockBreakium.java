...
public class BlockBreakium extends ModBlockOreBase {
	public BlockBreakium(String modid, String name, CreativeTabs tab, int minXp, int maxXp, Material material,
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player) {
		...
		if (tool != null && tool.isItemStackDamageable() && !player.capabilities.isCreativeMode) {
			tool.damageItem(tool.getMaxDamage(), player);
		}
	}
}