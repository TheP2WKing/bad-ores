...
public class ItemCrashiumAxe extends ModItemAxeBase {
	public ItemCrashiumAxe(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
