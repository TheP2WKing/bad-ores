...
public class ItemSmiteSword extends ModItemSwordBase {
	public ItemSmiteSword(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
