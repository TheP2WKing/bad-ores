...
public class ItemCrashiumHoe extends ModItemHoeBase {
	public ItemCrashiumHoe(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
