...
public class ItemNopiumShovel extends ModItemShovelBase {
	public ItemNopiumShovel(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
