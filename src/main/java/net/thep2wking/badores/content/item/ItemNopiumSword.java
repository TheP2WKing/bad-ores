...
public class ItemNopiumSword extends ModItemSwordBase {
	public ItemNopiumSword(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
