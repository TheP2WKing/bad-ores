...
public class ItemSmitePickaxe extends ModItemPickaxeBase {
	public ItemSmitePickaxe(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
