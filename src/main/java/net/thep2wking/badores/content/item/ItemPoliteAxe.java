...
public class ItemPoliteAxe extends ModItemAxeBase {
	public ItemPoliteAxe(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
