...
public class ItemAmadeumPickaxe extends ModItemPickaxeBase {
	public ItemAmadeumPickaxe(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
