...
public class ItemAmadeumHoe extends ModItemHoeBase {
	public ItemAmadeumHoe(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
