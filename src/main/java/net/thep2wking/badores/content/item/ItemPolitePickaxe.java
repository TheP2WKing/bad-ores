...
public class ItemPolitePickaxe extends ModItemPickaxeBase {
	public ItemPolitePickaxe(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
