...
public class ItemCrashiumSword extends ModItemSwordBase {
	public ItemCrashiumSword(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
