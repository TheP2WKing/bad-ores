...
public class ItemEnderiteSword extends ModItemSwordBase {
	public ItemEnderiteSword(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
