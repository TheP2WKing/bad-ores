...
public class ItemEnderiteAxe extends ModItemAxeBase {
	public ItemEnderiteAxe(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
