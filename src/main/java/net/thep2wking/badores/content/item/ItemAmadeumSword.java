...
public class ItemAmadeumSword extends ModItemSwordBase {
	public ItemAmadeumSword(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
