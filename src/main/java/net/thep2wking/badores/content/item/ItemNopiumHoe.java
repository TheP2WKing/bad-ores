...
public class ItemNopiumHoe extends ModItemHoeBase {
	public ItemNopiumHoe(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
