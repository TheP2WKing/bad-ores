...
public class ItemAmadeumAxe extends ModItemAxeBase {
	public ItemAmadeumAxe(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
