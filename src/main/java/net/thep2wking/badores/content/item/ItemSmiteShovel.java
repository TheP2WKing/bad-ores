...
public class ItemSmiteShovel extends ModItemShovelBase {
	public ItemSmiteShovel(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
