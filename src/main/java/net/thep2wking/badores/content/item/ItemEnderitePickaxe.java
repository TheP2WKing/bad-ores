...
public class ItemEnderitePickaxe extends ModItemPickaxeBase {
	public ItemEnderitePickaxe(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
