...
public class ItemPoliteHoe extends ModItemHoeBase {
	public ItemPoliteHoe(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
