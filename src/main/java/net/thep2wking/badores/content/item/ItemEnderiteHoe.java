...
public class ItemEnderiteHoe extends ModItemHoeBase {
	public ItemEnderiteHoe(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
