...
public class ItemCrashiumPickaxe extends ModItemPickaxeBase {
	public ItemCrashiumPickaxe(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
	...
	public boolean onLeftClickEntity(ItemStack stack, EntityPlayer player, Entity entity) {
		...
		ModItemEvents.crashiumAttackCrash(world, player);
	...
	public boolean onBlockDestroyed(ItemStack stack, World worldIn, IBlockState state, BlockPos pos,
		...
		ModItemEvents.crashiumUseCrash(worldIn, player);
