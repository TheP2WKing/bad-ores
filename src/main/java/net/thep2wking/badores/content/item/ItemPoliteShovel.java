...
public class ItemPoliteShovel extends ModItemShovelBase {
	public ItemPoliteShovel(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
