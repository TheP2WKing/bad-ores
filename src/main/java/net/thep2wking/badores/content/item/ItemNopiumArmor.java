...
public class ItemNopiumArmor extends ModItemArmorBase {
	public ItemNopiumArmor(String modid, String name, CreativeTabs tab, ArmorMaterial material, int renderIndex,
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack) {
		ModItemEvents.nopiumArmorTickDrop(world, player, itemStack, this.getEquipmentSlot().getSlotIndex() - 1);
	}

	@Override
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
		EntityPlayer player = (EntityPlayer) entityIn;
		if (itemSlot != this.getEquipmentSlot().getSlotIndex() - 1) {
