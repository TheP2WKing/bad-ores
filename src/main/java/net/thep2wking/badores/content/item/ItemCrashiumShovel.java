...
public class ItemCrashiumShovel extends ModItemShovelBase {
	public ItemCrashiumShovel(String modid, String name, CreativeTabs tab, ToolMaterial material, float attackDamage,
