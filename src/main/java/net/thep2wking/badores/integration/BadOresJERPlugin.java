	...
	public static void register() {
		...
		if (BadOresConfig.INTEGRATION.JER_INTEGRATION) {
			...
			addOreGen(ModBlocks.WANNAFITE_ORE, 6, 6, 1, 64,
					new LootDrop[] { new LootDrop(new ItemStack(Items.IRON_SWORD, 1, 0)) });
			addOreGen(ModBlocks.BREAKIUM_ORE, 6, 6, 1, 64);
			addOreGen(ModBlocks.STONIUM_ORE, 15, 60, 32, 256,
					new LootDrop[] { new LootDrop(new ItemStack(Blocks.COBBLESTONE, 1, 0)) });
			...
			addOreGen(ModBlocks.LITE_ORE, 4, 4, 1, 48,
			...
			addSpikeOreGen(ModBlocks.PAINTITWHITE_ORE, 60, 40, 0.0002f,
					new LootDrop[] { new LootDrop(new ItemStack(Items.DYE, 1, 15)) });
			addOreGen(ModBlocks.IWONTFITE_ORE, 6, 6, 1, 64);
			addOreGen(ModBlocks.TAUNTUM_ORE, 4, 4, 1, 48);
			addOreGen(ModBlocks.PANDAEMONIUM_ORE, 4, 6, 1, 10,
					new LootDrop[] { new LootDrop(new ItemStack(Blocks.NETHERRACK, 2, 0)),
